    ...
    <div className="flex flex-col min-h-screen font-merriweather">
      ...
      <div className="flex-col p-12">
        ...
        <div className="flex flex-row w-full">
          ...
          <div className="flex justify-center w-1/2 object-right">
            <Image className="rounded-full" src="/self.jpg" alt="Joe playing taiko" width="450" height="450" />
          </div>
        </div>
      </div>
      <div className="w-full flex flex-row pl-12">
        <div className="flex flex-row w-1/2 underline decoration-jm-yellow text-xl font-bold">
